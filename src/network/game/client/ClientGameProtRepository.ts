...
import SendSnapshotDecoder from '#/network/game/client/codec/SendSnapshotDecoder.js';
...
import SendSnapshotHandler from '#/network/game/client/handler/SendSnapshotHandler.js';
...
class ClientGameProtRepository {
    ...
    constructor() {
        ...
        this.bind(new SendSnapshotDecoder(), new SendSnapshotHandler());
